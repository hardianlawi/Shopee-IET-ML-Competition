...
print("convert and process test images...")
...
print("clean garbage collector...")
del all_imgs, test_imgs
gc.collect()

# Define a splitter
print("define a splitter")
